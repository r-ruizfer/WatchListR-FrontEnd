...
function Sidebar({ setFilterValue, setWatchlistFilter, handleCloseSidebar }) {
  ...
  if (genres === null) {
    return (
      <h1 style={{ backgroundColor: "#44475a", color: "#f1fa8c" }}>
        ...cargando...
      </h1>
    );
  }
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-list">
        ...
        <Button variant="outline-danger" value="" onClick={handleFilter}>
